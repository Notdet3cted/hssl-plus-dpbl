...
class ClassifierTrainer:
    def __init__(self, seed=42):
        ...
        self.windowed_dir = self.tracker.config["paths"].get("windowed", "data/windowed/")
        ...
        self.ssl_embeddings_dir = self.tracker.config["paths"].get("embeddings_ssl", "embeddings/ssl/")
        self.ssl_dpbl_embeddings_dir = self.tracker.config["paths"].get("embeddings_ssl_dpbl", "embeddings/ssl_dpbl/")
        self.results_dir = self.tracker.config["paths"].get("results", "results/")
        self.predictions_dir = self.tracker.config["paths"].get("results_predictions", "results/predictions/")
